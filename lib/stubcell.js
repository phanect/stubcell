...
StubCell.prototype._getMatchEntry = function(req, entries){
  entries = entries.filter(function(entry) {
    return check.request(entry.request, req, this.looseCompare);
  });
  ...
  switch (specs.length) {
    ...
    case 0:
      return null;
    default: // 2 or more
      var msg = "Duplicate specs in " + entry.request.url + " (" + entry.request.method + ")";
...
StubCell.prototype._getMatchSpec = function(req, entry) {
  var specs = entry.request.specs.filter(function(spec, i) {
